...
#gera a matriz 10 x 10 com as posicões vazias " "
matriz = full((10, 10), " ")
...
#preenche a matriz como 5 pacotes(#) em posições aleatorias
i = 0
while i < 5:
    Linha_aleatoria = randint(0,9)
    coluna_aleatoria = randint(0,9)
...
while True:
    ...
    if movimento.lower() == "a":
        ...
        if (coluna_atual - 1 < 0):
            print("O robo não consegui ir mais para a esquerda, tente outro movimento")
        else:
        ...
        if (coluna_atual + 1 > 9):
            print("O robo não consegui ir mais para a direita, tente outro movimento")
        else:
            matriz[Linha_atual][coluna_atual] = ' '
            matriz[Linha_atual][coluna_atual + 1] = 'R'
        ...
        if (Linha_atual - 1 < 0):
            print("O robo não consegui ir mais para cima, tente outro movimento")
        else:
            matriz[Linha_atual][coluna_atual] = ' '
        ...
        if (Linha_atual + 1 > 9):
            print("O robo não consegui ir mais para baixo, tente outro movimento")
        else:
            matriz[Linha_atual][coluna_atual] = ' '
            matriz[Linha_atual + 1][coluna_atual] = 'R'
